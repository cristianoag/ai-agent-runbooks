...
**Optional live briefing research:** [MCP Federated Connectors](../../02-patterns/MCP-Federated-Connectors/MCP-Federated-Connectors.md)
can retrieve current, permission-scoped book-of-record or CRM context without a Microsoft 365
external-data index, where the source and tenant have a suitable connector. Use a supported
companion experience such as Copilot Chat or Researcher; do not assume this enables the existing
declarative or Copilot Studio agent. Retain source citations, "as at" timestamps, information
barriers, and the no-advice boundary. Private-only core systems need a separately approved
connectivity design; file-note filing and CRM writes remain separate actions.
