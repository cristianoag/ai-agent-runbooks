...
**Optional legal research companion:** [MCP Federated Connectors](../../02-patterns/MCP-Federated-Connectors/MCP-Federated-Connectors.md)
can support live, read-only evidence lookup in an external matter repository or approved legal
research source through a supported experience such as Microsoft 365 Copilot Researcher.
Require a suitable provider or custom connector, matter-level permissions, and legal approval
of the processing boundary. No external-data index does not mean no data leaves the source.
This is not automatic Copilot Studio grounding and does not replace OCR, clause extraction,
redlining, or qualified legal review.
