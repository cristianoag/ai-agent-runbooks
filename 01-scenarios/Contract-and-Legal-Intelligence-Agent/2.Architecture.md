...
### Optional external research companion

For evidence assembly from an external matter repository or approved legal research provider,
consider [MCP Federated Connectors](../../02-patterns/MCP-Federated-Connectors/MCP-Federated-Connectors.md)
in a supported Microsoft 365 Copilot Researcher experience. This requires provider/tenant support
or a custom MCP connector; it does not give the Copilot Studio extraction pipeline automatic
access to federated sources.

Apply matter-level source permissions, verify citations and document versions, and have legal
approve the processing boundary before connecting privileged material. Live retrieval avoids a
Microsoft 365 external-data index, but retrieved text still enters the Copilot processing path.
Follow the [federated connector runbook](../../02-patterns/MCP-Federated-Connectors/MCP-Federated-Connectors-Runbook.md)
for access tests. Keep OCR, structured clause comparison, redline production, and human sign-off
in the primary architecture; research results are not proof of an exhaustive legal review.

### Existing confidentiality controls
